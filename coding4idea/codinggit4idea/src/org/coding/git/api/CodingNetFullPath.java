...
*/
public class CodingNetFullPath {
  @NotNull private final String myUserName;
  @NotNull private final String myRepositoryName;

  public CodingNetFullPath(@NotNull String userName, @NotNull String repositoryName) {
    myUserName = userName;
  ...
  public boolean equals(@Nullable Object o) {
    ...
    CodingNetFullPath that = (CodingNetFullPath)o;

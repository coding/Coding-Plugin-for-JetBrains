...
class CodingNetPullRequestRequest {
  ...
  public CodingNetPullRequestRequest(@NotNull String title, @NotNull String description, @NotNull String head, @NotNull String base) {
    this.title = title;

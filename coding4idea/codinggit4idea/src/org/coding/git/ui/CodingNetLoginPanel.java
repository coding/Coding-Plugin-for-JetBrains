 ...
 * @date 10/20/10
 */
public class CodingNetLoginPanel {
    ...
    private JTextField myVerificationCodeTextField;
    private JPanel myVerificationCodePanel;
    private JLabel myVerificationLabel;

    private final static String AUTH_PASSWORD = "Password";
    //private final static String AUTH_TOKEN = "Token";

    public CodingNetLoginPanel(final CodingNetLoginDialog dialog) {
...
//        }
        ...
        myVerificationLabel.setVisible(false);
        myVerificationCodePanel.setVisible(false);
        myVerificationCodeTextField.setVisible(false);
    }
    ...
    public void setAuthType(@NotNull CodingNetAuthData.AuthType type) {
        switch (type) {
            case BASIC:
...
//        break;
    ...
    public void lockAuthType(@NotNull CodingNetAuthData.AuthType type) {
        setAuthType(type);
...
//    if (AUTH_TOKEN.equals(selected)) return CodingNetAuthData.createTokenAuth(getHost(), getPassword());
//    CodingNetUtil.LOG.error("CodingNetLoginPanel illegal selection: anonymous AuthData created", selected.toString());
